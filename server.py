...
@mcp.resource("mysql://localhost/schema")
def get_schema_resource() -> str:
    """Proporciona el esquema completo de la base de datos como un recurso JSON."""
...
@mcp.prompt("leccion-sql")
def sql_lesson_prompt(tema: str = "Conceptos Basicos") -> str:
    """Crea una leccion personalizada basada en un tema SQL."""
    return f"Quiero aprender sobre {tema} en MySQL. Revisa el esquema de mi base de datos actual y dame un ejemplo practico usando mis tablas."

@mcp.prompt("auditoria-esquema")
def schema_audit_prompt() -> str:
    """Analiza el diseño de la base de datos en busca de mejoras."""
    return "Por favor, analiza el esquema de mi base de datos actual. Busca falta de claves primarias, problemas de normalizacion y sugiere indices apropiados."
